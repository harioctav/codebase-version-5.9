...
export default class Template {
  ...
  _uiHandleDarkMode(mode) {
    ...
    if (["on", "off", "system"].includes(mode)) {
      if (mode === "on") {
        ...
        if (rememberDarkMode) {
          localStorage.setItem("codebaseDarkMode", "on");
        }
        ...
        // Save dark mode preference
        if (rememberDarkMode) {
          localStorage.setItem("codebaseDarkMode", "off");
        }
        ...
        // Save dark mode preference
        if (rememberDarkMode) {
          localStorage.setItem("codebaseDarkMode", "system");
        }
      ...
      if (rememberDarkMode) {
        darkMode = localStorage.getItem("codebaseDarkMode") || self._darkMode;
      } else {
  ...
  _uiHandleTheme() {
    ...
    if (rememberTheme) {
      let themeName = localStorage.getItem("codebaseColorTheme") || false;
    ...
    document.querySelectorAll('[data-toggle="theme"]').forEach((el) => {
      el.addEventListener("click", (e) => {
        ...
        if (rememberTheme) {
          localStorage.setItem("codebaseColorTheme", themeName);
        }
      });
    });
  }
